...
echo  [4/4] Copying path to clipboard + opening Chrome...
...
echo.
echo  After "Load unpacked", you DON'T need to type your password.
echo  Just go to cursive.world/pdtracker and the extension will
echo  sign you in automatically.
echo.
echo  ===============================================================
echo.
